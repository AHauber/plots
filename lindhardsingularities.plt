...
set style line 2  linetype 2 linewidth 2.000 pointtype 2 pointsize default pointinterval 0
set style line 3  linetype 3 linewidth 2.000 pointtype 3 pointsize default pointinterval 0
unset style arrow
...
GNUTERM = "x11"
GPFUN_f = "f(x)=x*(2+x)"
GPFUN_g = "g(x)=x*abs(x-2)"
plot '+' using 1:(f($1)):(g($1)) w filledcurves closed notitle ls 7, x*(2-x) w filledcu closed notitle ls 6 , x*(x+2) w l ls 1 t "1+b-c", x*(x-2) w l ls 2 t "1-b+c" , x*(2-x) w l ls 3 t "1-b-c"
#    EOF
