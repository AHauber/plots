...
set xtics   ("k_h" 3.00000, "k_f" 4.00000, "k_e" 4.47214)
set ytics border in scale 1,0.5 mirror norotate  autojustify
set ytics  norangelimit
set ytics   ("E_h" 9.00000, "E_F" 16.0000, "E_e" 20.0000)
...
set rtics border in scale 1,0.5 nomirror norotate  autojustify
...
kh = 3
ke = 4.47213595499958
plot (x<4)?x**2:(1/0) with  filledcurves y1 = 16 t "Fermi sea" lc 3,\
 x**2 w l lw 2 t "E_k",\
 (x<kf)?kf**2:(1/0) w l lw 2 t "",\
 (x<kh)?kh**2:(1/0) w l lw 2 lc 1 t "",\
(x<ke)?ke**2:(1/0) w l lw 2  lc 7 t ""
#    EOF
